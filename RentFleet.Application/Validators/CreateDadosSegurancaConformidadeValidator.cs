...
{
    public class CreateDadosSegurancaConformidadeValidator : AbstractValidator<CreateDadosSegurancaConformidadeCommand>
    {
        public CreateDadosSegurancaConformidadeValidator()
        {
